...
class WysiwygEditor extends Component {
  ...
  onSuggestionsFocus = (event) => {
    const { onFocus } = this.props;
    if (onFocus && this.focusHandler.isSuggestionsFocused()) {
      onFocus(event);
    }
  };
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        {editorFocused && suggestions && suggestions.length ? (
          <div
            className={"rdw-editor-suggestions suggestions"}
            onMouseDown={this.preventDefault}
            aria-label="rdw-suggestions"
